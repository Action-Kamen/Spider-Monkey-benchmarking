...
int main(int argc, char** argv) {
  ...
  gDumpBytecode = op.getBoolOption('G');
  fprintf(gErrFile->fp, "Dumping bytecode: %s\n",
         gDumpBytecode ? "enabled" : "disabled");
...
bool InitOptionParser(OptionParser& op) {
  ...
  if (!op.addMultiStringOption(
      ...
      !op.addBoolOption('G', "get-bytecode", "Dump bytecode for all compiled scripts")||
