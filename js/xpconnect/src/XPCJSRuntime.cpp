...
static void SetUseCounterCallback(JSObject* obj, JSUseCounter counter) {
  switch (counter) {
    ...
    case JSUseCounter::DATEPARSE_IMPL_DEF:
      ...
      return;
    case JSUseCounter::ION_BACKEND:
      SetUseCounter(obj, eUseCounter_custom_JS_ion_backend);
      return;
    case JSUseCounter::PROPERTY_KEY_ACCESS:
      SetUseCounter(obj, eUseCounter_custom_JS_property_key_access);
      return;
    case JSUseCounter::STRICTLY_EQUAL:
      SetUseCounter(obj, eUseCounter_custom_JS_strictly_equal);
      return;
    case JSUseCounter::GET_PROP:
      SetUseCounter(obj, eUseCounter_custom_JS_get_prop);
      return;
    case JSUseCounter::GET_ELEM:
      SetUseCounter(obj, eUseCounter_custom_JS_get_elem);
      return;
    case JSUseCounter::TO_NUMERIC:
      SetUseCounter(obj, eUseCounter_custom_JS_to_numeric);
      return;
    case JSUseCounter::TO_STRING:
      SetUseCounter(obj, eUseCounter_custom_JS_to_string);
      return;
